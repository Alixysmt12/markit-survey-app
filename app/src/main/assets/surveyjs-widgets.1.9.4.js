...
function init(Survey) {
  var widget = {
    ...
    htmlTemplate:
      "<div style='height: 39px; display:none'>" +
      "<button type='button'  title='Record' id='btnRecordingStarts' style='vertical-align: top; margin-top: 3px' ><i class='fa fa-microphone' aria-hidden='true'></i></button>" +
      "&nbsp;<button type='button' title='Save' id='btnRecordingStops' style='vertical-align: top; margin-top: 3px'><i class='fa fa-cloud' aria-hidden='true' ></i></button>" +
      "&nbsp;<audio style='" +
      "vertical-align: top;" +
      "margin-left: 10px;" +
      "height:35px;" +
    ...
    afterRender: function(question, el) {
      ...
      var SaveBlobAs = function (blob, file_name) {
      ...
      var processAudio = function(audioVideoWebMURL) {
        ...
        var file = new File([recordedBlob], "name");
     //   console.log(file);
       JSON.stringify(file);
        SaveBlobAs(recordedBlob, 'hahaha');
var generateGUID = function () {
		return 'xxxxxx-4xxx-xxxxxx'.replace(/[xy]/g, function(c) {
        ...
        //  console.log("dataUri: " + dataUri);
         var uniqueID =  generateGUID();
          question.value = uniqueID;
          audioEl.src = dataUri;
Android.sendAudioData(dataUri,uniqueID,question.name);
